...
IDX_01 = {
    ...
    "elementos": [
        ...
        e("01_resumo_k07_fiscal",           "RESUMO_K07_FISCAL",           "KPI","Risco Fiscal 2027",    "01_resumo_k00_kpis.json",{"chave":"fornecedores_ativos","fmt":"num","state":"warn"},                                                                                  col=13, col_span=2, row=1,row_span=2),
        e("01_resumo_k08_cp",               "RESUMO_K08_CP",               "KPI","CP em Aberto",         "01_resumo_k00_kpis.json",{"chave":"cp_aberto","fmt":"brl","state":"alert","delta_chave":"cp_titulos","delta_ctx":"títulos"},                                          col=15, col_span=2, row=1,row_span=2, zoho="CP"),
...
IDX_06 = {
    ...
    "grid":{"colunas":16,"row_height_px":40},
    "elementos":[
        e("06_fornecedor_k01_ativos",  "FORNECEDOR_K01_ATIVOS",  "KPI","Fornecedores Ativos",  "06_fornecedor_k00_kpis.json",{"chave":"fornecedores_ativos","fmt":"num"},                 col=1, col_span=3,row=1,row_span=2,zoho="NFE"),
        e("06_fornecedor_k02_spend",   "FORNECEDOR_K02_SPEND",   "KPI","Spend AAA/AA/A",        "06_fornecedor_k00_kpis.json",{"chave":"spend_curva_aaa_aa_a","fmt":"brl"},               col=4, col_span=3,row=1,row_span=2,zoho="CURVA ABC FORN"),
        e("06_fornecedor_k03_pct",     "FORNECEDOR_K03_PCT",     "KPI","% do Spend",             "06_fornecedor_k00_kpis.json",{"chave":"pct_spend_top","fmt":"pct"},                     col=7, col_span=3,row=1,row_span=2),
        e("06_fornecedor_k04_cp",      "FORNECEDOR_K04_CP",      "KPI","Forn. com CP Aberto",   "06_fornecedor_k00_kpis.json",{"chave":"forn_com_cp_aberto","fmt":"num","state":"warn"},  col=10,col_span=3,row=1,row_span=2,zoho="CP"),
        e("06_fornecedor_k05_ad",      "FORNECEDOR_K05_AD",      "KPI","Forn. com AD Pendente", "06_fornecedor_k00_kpis.json",{"chave":"forn_com_ad_pendente","fmt":"num","state":"warn"}, col=13,col_span=4,row=1,row_span=2,zoho="AD_v3"),
        e("06_fornecedor_r01_tabela",  "FORNECEDOR_R01_TABELA",  "TE","Tabela Fornecedor 360",  "06_fornecedor_r01_tabela_principal.csv",{"colunas":[{"key":"fornecedor","label":"Fornecedor","cls":"nm"},{"key":"curva","label":"Curva"},{"key":"empresas","label":"Empresas"},{"key":"spend_total","label":"Spend","cls":"num","fmt":"brl"},{"key":"imp_cot","label":"IMP_COT","cls":"num","fmt":"brl"},{"key":"cp_aberto","label":"CP Aberto","cls":"num","fmt":"brl"},{"key":"ad_pendente","label":"AD Pend.","cls":"num","fmt":"brl"}],"expandable":True},col=1,col_span=16,row=3,row_span=12,subtitulo="expandir para ver detalhe",zoho="NFE · CP · AD_v3"),
        # Tipo B
